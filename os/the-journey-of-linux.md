...
- 变量
  ...
  ulimit：这里有个实战，http://blog.csdn.net/puma_dong/article/details/45001517
...
- 管道命令
  ...
  **常用管道命令：**
  ...
  grep：针对行分析，过滤字符串，常用于文件过大时，不适合用 vim 打开的厂家
...
- http状态码
  - 400
    ...
    请求时定义了“Entity Head Field”，Content-Type json，导致--data失效
  ...
  - 415
    ...
    错误原因：没有定义媒体类型，默认用text/plain开启调用，服务器端不支持。
